...
>
> **Última reconciliación contra el código: 2026-06-10.** Se cerró §10.3 (frontera
...
> Verticales construidos: Contabilidad y Granja. Riel de packs construido; primer
> pack concreto "Adjuntos a comprobantes" (`contabilidad.adjuntos`) CONSTRUIDO
> (change `pack-adjuntos-comprobantes`, PR #187, 2026-06-10).
> Dashboard portfolio super-admin construido (PR #159).
>
...
| Pack "Adjuntos a comprobantes" (`contabilidad.adjuntos`) | ✅ construido (change `pack-adjuntos-comprobantes`, PR #187, 2026-06-10). Primer pack concreto. `AdjuntoComprobante` + `StoragePort`/MinIO + 5 endpoints + frontend `AdjuntosSection`. Spec viva: `openspec/specs/pack-adjuntos-comprobantes/spec.md` |
| Packs avícolas concretos restantes (compras/fletes/liquidaciones/RAG) | ❌ greenfield (el riel y el primer pack están hechos; siguientes packs según prioridad de Marco) |
...
3. **Riel de packs (eje 2)** — ✅ **construido** (change `packs-riel`, 2026-06-02,
   ...
   cerrada. **Primer pack concreto enchufado**: ✅ "Adjuntos a comprobantes"
   (`contabilidad.adjuntos`), change `pack-adjuntos-comprobantes` (PR #187,
   2026-06-10). Ver `docs/disenos/packs-eje2.md`.

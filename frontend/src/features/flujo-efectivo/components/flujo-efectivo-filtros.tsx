...
interface FlujoEfectivoFiltrosProps {
  /** Callback cuando el usuario envía el formulario con filtros válidos. */
  onBuscar: (values: FlujoEfectivoFiltroValues) => void;
 ...
 *
 * Sin modo `gestionId` — el EFE solo expone período XOR rango (a diferencia del EEPN).
 * Modo "rango de fechas" por default. Modo "período fiscal" para evaluar un mes puntual.
 * Toggle "Incluir anulados" disponible en ambos modos.
 */
export function FlujoEfectivoFiltros({
  onBuscar,
  isFetching = false,
  ...
  return (
    ...
    >
      ...
      <div className="flex flex-wrap items-end gap-3">
        ...
        {modo === 'rango' && (
          <>
            <div className="space-y-1">
              <Label htmlFor="efe-fecha-desde" className="text-xs text-muted-foreground">
                Desde
              </Label>
              <Input
                id="efe-fecha-desde"
            ...
            <div className="space-y-1">
              <Label htmlFor="efe-fecha-hasta" className="text-xs text-muted-foreground">
                Hasta
              </Label>
              <Input
                id="efe-fecha-hasta"
        ...
        {modo === 'periodo' && (
          <div className="space-y-1">
            <Label htmlFor="efe-periodo" className="text-xs text-muted-foreground">
              Período fiscal
            </Label>
            <Select
        ...
        <div className="flex items-center gap-2 pb-0.5">
          ...
          />
          <Label htmlFor="efe-anulados" className="text-sm cursor-pointer">
            Incluir anulados
          </Label>
        </div>

        {/* Botón consultar — Anti-F-07: deshabilitado mientras isFetching */}

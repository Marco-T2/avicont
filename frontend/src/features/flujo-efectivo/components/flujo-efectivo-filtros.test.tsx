...
// (payload usa fechaDesde/fechaHasta; la traducción a desde/hasta la hace el api)
// ============================================================

describe('FlujoEfectivoFiltros — default Gestión + Todos', () => {
  it('al consultar con el default (Todos) emite rango de toda la gestión con fechaDesde/fechaHasta', async () => {
...
describe('FlujoEfectivoFiltros — mes específico', () => {
...
describe('FlujoEfectivoFiltros — incluir anulados', () => {
...
describe('FlujoEfectivoFiltros — rango personalizado', () => {

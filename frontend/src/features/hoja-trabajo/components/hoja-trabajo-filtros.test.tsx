...
describe('HojaTrabajoFiltros — default Gestión + Todos', () => {
...
describe('HojaTrabajoFiltros — mes específico', () => {
...
describe('HojaTrabajoFiltros — incluir anulados', () => {
...
describe('HojaTrabajoFiltros — rango personalizado', () => {

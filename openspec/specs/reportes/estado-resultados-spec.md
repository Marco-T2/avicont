# Estado de Resultados — Especificación Canónica

<!--
Última edición: 2026-05-31
Última revisión contra core: 2026-05-31
Owner: backend-lead
Status: CANONIZADA (archivado de reportes-estado-resultados)
-->

> Fecha: 2026-05-31
> Proyecto: avicont
> Capability: `estado-resultados`
> Estatus: SPEC OFICIAL (sinced from change reportes-estado-resultados, delta spec merged)
...
### D-02: Duplicación de `parseFechaContable`

La función `parseFechaContable` está duplicada en 4 servicios:
...
**Follow-up**: extraer a utilidad común en `src/reportes/domain/` o `src/common/`.
**Prioridad**: baja (todo está testeado; es limpieza técnica, no bug de negocio).
**Estimada**: 1-2 horas en próxima sesión si se atrapa con otra feature.

# Exportación a Excel — Especificación (Fase A)

<!--
Última edición: 2026-06-04
Última revisión contra core: 2026-06-04
Owner: frontend-lead
-->

## Propósito

Infraestructura frontend reutilizable para serializar informes contables bolivianos a `.xlsx`, con cabecera fiscal de la organización, formateo es-BO, montos escritos como celda numérica (sin recálculo) y descarga del blob en el navegador. La Fase A construye esta infraestructura una sola vez y la valida con el **Libro Diario** como informe piloto. Las Fases B (Libro Mayor, Balance General, Estado de Resultados) y C (Comprobantes) quedan fuera de scope; reutilizarán esta misma capacidad.
...
### Requisito ADDED: Builder genérico de hoja Excel
...
### Requisito ADDED: Bloque de cabecera fiscal
...
### Requisito ADDED: Formateo es-BO de montos y fechas
...
### Requisito ADDED: Descarga del blob en el navegador
...
### Requisito ADDED: Libro Diario — Exportar a Excel (piloto)
...
- Fuera de scope de la Fase A: Libro Mayor, Balance General, Estado de Resultados (Fase B); Comprobantes (Fase C); export a PDF; estilos ricos (logo embebido, temas).
